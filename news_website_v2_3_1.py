# -*- coding: utf-8 -*-
"""news website v2.3.1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1F3en0GiiTE7mdy3136rO1g6-A4rAFHam
"""
...
.gemma-btn:hover a {
  ...
  <style>
    ...
    /* Fade-in animation when sources open */
    details[open] table {
  ...
  <div class="nav-container">
    {% for cat_name, subcats in categories.items() %}
      <div class="dropdown">
        <button class="dropbtn"><a href="#{{ cat_name }}"><b style="color:GhostWhite;">{{ cat_name }} ▼</b></a></button>
        <div class="dropdown-content">
          {% for subcat_name, subcat_highlight, articles in subcats %}
            <a href="#{{ subcat_name }}">{{ subcat_name }}</a>
          {% endfor %}
        </div>
      </div>
    {% endfor %}
    <div class="dropdown">
    <button class="dropbtn gemma-btn"><a href="/gpt_qna" style="color:white; text-decoration:none;">Ask Gemma 3!</a></button>
  ...
  <h1 style = 'font-size: 35px;'>Executive Summary</h1>
  <p style="max-width: 85ch; text-align: justify; white-space: pre-wrap; font-size: 14px;" >{{ exec_sum }}</p><br><br>


  {% for cat_name, subcats in categories.items() %}
  <h1 style = 'font-size: 35px;' id="{{ cat_name }}">{{ cat_name }}</h1>

  {% for subcat_name, subcat_highlight, articles in subcats %}
    <div class="subcat-block">
      <h2 style = 'font-size: 25px;' id="{{ subcat_name }}"><strong style="color:DodgerBlue;">{{ subcat_name }}</strong></h2>
      <p style = 'font-size: 14px;' class="highlight-text"><b style="color:Tomato;">>>></b> {{ subcat_highlight }}</p>
...
.gemma-btn:hover a {
  ...
  <nav class="navbar">
  <div class="nav-container">
    <button class="dropbtn"><a href="https://unmisanthropic-margarito-nonexcitative.ngrok-free.dev/"><b style="color:GhostWhite;">HOME </b></a></button>
    ...
    <h1 style = 'font-size: 35px;'>Ask Gemma 3-27B!</h1>
    <form action="/predict" method="post" ,="" name="form">
      <p style = 'font-size: 14px;'><strong>Ingest (from homepage articles):</strong></p>
      <input type="text" ,="" size="30" id="ingest" name="ingest" placeholder="What is the context?">
      <p style = 'font-size: 14px;'><strong>Prompted Question:</strong></p>
      <input type="text" ,="" size="30" id="qna" name="qna" placeholder="What is your question?">
      <p style="max-width: 85ch; text-align: justify; font-size: 14px;"><strong>Creativity (0 - 100, 0 for succinct and minimal additions, 100 for free range creativity and elaborative):</strong></p>
      <input type="text" ,="" id="creativity" name="creativity" placeholder="0 to 100"><br><br>
      <input type="range" id="creativity2" name="creativity2" min="0" max="100" value="50" oninput="this.nextElementSibling.value = this.value"><output>50</output><br><br>
      <button value="Submit">Reply</button>
    </form>
    <p style="max-width: 85ch; text-align: justify;  white-space: pre-wrap; font-size: 14px;"><b>Gemma 3's reply:</b> {{ reply | e }}</p><br><br>
    <p style="max-width: 85ch; text-align: justify; white-space: pre-wrap; font-size: 14px;"><b>Gemma 3's report:</b> {{ report | e}}</p>
    <a href="https://ai.google.dev/gemma/prohibited_use_policy"><p style="font-size: 8px;">Gemma Restricted Use Policy</p></a>
    <a href="https://ai.google.dev/gemma/terms"><p style="font-size: 8px;">Gemma T&C</p></a>
</body>
</html>
...
.gemma-btn:hover a {
  ...
  <div class="nav-container">
    ...
    <div class="dropdown">
      <button class="dropbtn"><b style="color:GhostWhite;">World Bank Plots ▼</b></button>
      <div class="dropdown-content">
    ...
    <p style="max-width: 85ch; text-align: justify;  white-space: pre-wrap; font-size: 14px;"><b>Gemma's summary:</b> {{ summary | e }}</p><br><br>
    <p style="max-width: 85ch; text-align: justify;  white-space: pre-wrap; font-size: 14px;"><b>Panda and Plotly's reply:</b></p><br><br>
    <hr><p style = 'font-size: 14px;  text-align: center;'><b style="color:Tomato;">Extracted from news article:</b></p><hr>
    {{ reply | safe }}
    {{ table1 | safe }}<br><br><br><br><br>

    <hr><p style = 'font-size: 14px; text-align: center;'><b style="color:Tomato;">News article Sentiments:</b></p><hr>
    {{ wc1 | safe}}
    {{ wc2 | safe}}<br><br><br><br><br>
    {{ reply2 | safe }}
    {{ table2 | safe }}<br><br><br><br><br>

    <hr><p style = 'font-size: 14px;  text-align: center;'><b style="color:Tomato;">Relevant World Bank Data:</b></p><hr>
    {% for plot_name, plot in wbplots %}
    ...
    <div>
    <details class="source-table">
        <summary><strong>📈 Description for World Bank Charts</strong></summary>
        <table>
...
.gemma-btn:hover a {
  ...
  <div class="nav-container">
    ...
    <form action="/search" method="post" name="form">
      ...
      <p style = 'font-size: 14px;'><strong>region (use wt-wt if unsure):</strong></p>
      <input type="text" ,="" size="30" id="region" name="region" placeholder="wt-wt,us-en,uk-en,ru-ru,cn-zh">
      <p style = 'font-size: 14px;'><strong>Should LLM include relevant World Bank data? (~10s - 40s longer) </strong></p>
      <input type="checkbox" id="include" name="include" value="Yes">
      <label for="include">Yes</label>
      <p style = 'font-size: 14px;'><strong>Maximum limit of world bank sources selected(default: 2)(~more sources, the longer) </strong></p>
    ...
    <br><br><br>
    <hr><p style = 'font-size: 14px;  text-align: center;'><b style="color:Tomato;">Gemma's Responses:</b></p><hr>
    ...
    {% endfor %}
    {% for plot_name, plot_desc in desc %}
      <p style = 'font-size: 14px;  text-align: center;'><b style="color:Tomato;">{{ plot_name }}</b></p>
      <p style = 'font-size: 14px;  text-align: justified;'>{{ plot_desc | safe }}</p>

    {% endfor %}
    <div>
    <details class="source-table">
        <summary><strong>📚 Sources for Gemma's Response</strong></summary>
        <table>
          <thead>
            <tr>
              <th>Feed</th>
...
@app.route('/')
def index():
  #categories = categories = ### raw categories in dictionary form
  return render_template_string(HTML_TEMPLATE1, categories=categories, exec_sum = exec_sum)

@app.route('/gpt_qna')
def gpt():
  return render_template_string(HTML_TEMPLATE2, reply="", categories=categories)

@app.route("/predict", methods = ['POST'])
def predict():
  ingest = request.form["ingest"]
  qna = request.form["qna"]
  if qna == "":
    return render_template_string(HTML_TEMPLATE5, error = "TEXTBOX ERROR", textbox="QNA")
  creativity = request.form["creativity"]
  creativity2 = request.form["creativity2"]
  all_sums = df_all[df_all['summary'].str.lower().str.contains(ingest.lower())]['summary'].tolist()
  read = "  ".join(all_sums)

  #reply = gpt.create_chat_completion(messages = msg)
  #previous re.sub substring: r'[^A-Za-z0-9+\-*/().= ]'
  if creativity >= creativity2:

    #from huggingface_hub import login

    #tokenizerG3b1 = AutoTokenizer.from_pretrained("google/gemma-3-270m-it")
    #modelG3b1 = AutoModelForCausalLM.from_pretrained("google/gemma-3-270m-it")

    base_labels = ['Geopolitics', 'Finance', 'Defense', 'Manufacturing', 'Technology', 'Logistics', 'Equity', 'Capital Markets', 'Science', 'Bond', 'International Relations']
    ###### new chunk, yet to test
    #messages = [{"role": "user", "content":f"Read this as input context: {read}. \n\nRead and response to this question: {qna} \n\nThe following score in percent measures your creative allowance from 0-100, 0 for succinct and minimal additions, 100 for free range creativity and elaborative. \nCreativity: {creativity} \n\nPrint only summary(ies), no chit-chat. Filter out all boilerplate words and noise. DO NOT add in hallucinated noise. DO NOT print anything similar to 'I need more information'. If no context, reply with: Try again with broader term. "},]
    #inputs = tokenizerG3b1.apply_chat_template(
    #    messages,
    ...
    #outputs = modelG3b1.generate(**inputs, max_new_tokens = round(0.7*input_length), min_new_tokens=round(0.2*input_length) )
    #response = tokenizerG3b1.decode(outputs[0][inputs["input_ids"].shape[-1]:])[0:-13]
    response = ai.generate_text(f"Read this as input context: {read}. \n\nRead and response to this question: {qna} \n\nThe following score in percent measures your creative allowance from 0-100, 0 for succinct and minimal additions, 100 for free range creativity and elaborative. \nCreativity: {creativity} \n\nPrint only summary(ies), no chit-chat. Filter out all boilerplate words and noise. DO NOT add in hallucinated noise. If no context, reply with: Try again with broader term. ", model_name='google/gemma-3-27b')
    response = re.sub(r'\\[a-zA-Z]+|[\${}*#]', '', str(response))

    ###### new chunk, yet to test
    #messages = [{"role": "user", "content":f"Read this as input context: {read}. \n\nRead and response to this question: {qna} \n\nThe following score in percent measures your creative allowance from 0-100, 0 for succinct and minimal additions, 100 for free range creativity and elaborative. \nCreativity: {creativity} \n\nPrint only a short 3 to 5 paragraph executive report, no chit-chat. Filter out all boilerplate words and noise. DO NOT add in hallucinated noise. If no context, reply with: Try again with broader term. "},]
    #inputs = tokenizerG3b1.apply_chat_template(
    #    messages,
    #    add_generation_prompt=True,
    #    tokenize=True,
    ...
    #input_length = inputs['input_ids'].shape[1]
    #outputs = modelG3b1.generate(**inputs, max_new_tokens = round(0.7*input_length), min_new_tokens=round(0.2*input_length) )
    #report = tokenizerG3b1.decode(outputs[0][inputs["input_ids"].shape[-1]:])[0:-13]
    report = ai.generate_text(f"Read this as input context: {read}. \n\nRead and response to this question: {qna} \n\nThe following score in percent measures your creative allowance from 0-100, 0 for succinct and minimal additions, 100 for free range creativity and elaborative. \nCreativity: {creativity} \n\nPrint only a short 3 to 5 paragraph executive report, no chit-chat. Filter out all boilerplate words and noise. DO NOT add in hallucinated noise. If no context, reply with: Try again with broader term. ", model_name='google/gemma-3-27b')
    report = re.sub(r'\\[a-zA-Z]+|[\${}*#]', '', str(report))

  elif creativity2 > creativity:
    ...
    #messages = [{"role": "user", "content":f"Read this as input context: {read}. \n\nRead and response to this question: {qna} \n\nThe following score in percent measures your creative allowance from 0-100, 0 for succinct and minimal additions, 100 for free range creativity and elaborative. \nCreativity: {creativity2} \n\nPrint only summary(ies), no chit-chat. Filter out all boilerplate words and noise. DO NOT add in hallucinated noise. If no context, reply with: Try again with broader term. "},]
    #inputs = tokenizerG3b1.apply_chat_template(
    #    messages,
    #    add_generation_prompt=True,
    #    tokenize=True,
    ...
    response = 'Creativity Score Error'

  return render_template_string(HTML_TEMPLATE2, reply=response, report=report, categories=categories)

@app.route('/pandas')
def pandas():
  return render_template_string(HTML_TEMPLATE3, reply="", categories=categories)
...
def ask():
  ...
  summary = re.sub(r'\\[a-zA-Z]+|[\${}*#]', '', str(summary))
  ...
  bdata2 = temp.to_html(index=False).replace('<td>', '<td align="center">')
  ...
  if include == "Yes":
    ...
    for i in indict:
      ...
      try:
        ...
        dfu = dfu[indict[i]]
        if (dfu.notna().values == True).sum() / ( dfu.shape[1]) > 1:
          ...
          if include_desc == 'Yes':
            plot_desc = ai.generate_text(f"Read this as news article: [{prompt}]. \n\nRead this dataframe which is used for a line chart called {indict[i]}: {dfu} \n\nPrint only an interpretation of the line chart and contextual summary(ies), no chit-chat. Filter out all boilerplate words and noise. DO NOT add in hallucinated noise. If no context, reply with: Try again with broader term. ", model_name='google/gemma-3-27b')
            plot_desc = re.sub(r'\\[a-zA-Z]+|[\${}*#]', '', plot_desc)
  ...
  return render_template_string(HTML_TEMPLATE3, summary = summary, reply=reply, table1 = bdata1, wc1 = fig1, wc2 = fig2, reply2 = reply2, table2=bdata2, wbplots = wbplots, desc = wbdesc, categories=categories)

@app.route('/find')
def find():
  return render_template_string(HTML_TEMPLATE4, reply1="", reply2='',reply3='', categories=categories)
...
def search():
  ...
  for i in results:
    texts.append(i['body'])
    feeds.append(i['url'])
  response = ai.generate_text(f"Extract 15 important key words from {" ".join(texts)}. You can create new strong term from combining weaker terms. Filter out extremely broad and generic terms. Exclusion list: {topic}. Give response in a list without scores. DO NOT label using numbers, instead use *  .DO NOT use acronyms or initialisms, always specify full phrase", model_name='google/gemma-3-27b')
  ...
  response = ai.generate_text(f"Extract 10 important key words from {" ".join(texts)}. You can create new strong term from combining weaker terms. Filter out extremely broad and generic terms. Exclusion list: {topic}. Give response in a list without scores. DO NOT label using numbers, instead use * .DO NOT use multiple ** in a sequence. You can use acronyms or initialisms given that you always specify the abbreviated name", model_name='google/gemma-3-27b')
  response = re.sub(r"[\[\(\{].*?[\]\)\}]", "", response)
  sch_key3 = response.split("\n* ")[1:-2]
  prompt = " ".join(texts)
  reply1 = ai.generate_text(f"Your Data to read: {" ".join(texts)}. Your Topic to analyse: {topic}.  Read but do not print these instructions in output: Print only an executive report, 1 to 2 paragraphs per section, include numbers if any, no chit-chat. Filter out all boilerplate words and noise. DO NOT add in hallucinated noise. DO NOT add date in title. Leave 4 nextlines after response. ", model_name='google/gemma-3-27b')
  reply1 = response = re.sub(r'\\[a-zA-Z]+|[\${}*#]', "", reply1)
  reply2 = ai.generate_text(f"Your Data to read: {" ".join(texts)}. Your Topic to analyse: {topic}. Your Sections: {sch_key3}. Read but do not print these instructions in output: Print only an executive report, 1 to 2 paragraphs per section, include numbers if any, no chit-chat. Filter out all boilerplate words and noise. DO NOT add in hallucinated noise. DO NOT add date in title. Leave 4 nextlines after response. ", model_name='google/gemma-3-27b')
  reply2 = response = re.sub(r'\\[a-zA-Z]+|[\${}*#]', "", reply2)
  reply3 = ai.generate_text(f"Your Data to read: {" ".join(texts)}. Your Topic to analyse: {topic}.  Read but do not print these instructions in output: Print only a report, recommend strategies and analyze, include numbers if any, no chit-chat. Filter out all boilerplate words and noise. DO NOT add in hallucinated noise. DO NOT add date in title. Leave 4 nextlines after response. ", model_name='google/gemma-3-27b')
  reply3 = response = re.sub(r'\\[a-zA-Z]+|[\${}*#]', "", reply3)
    ...
    for i in indict:
      ...
      try:
        ...
        if (dfu.notna().values == True).sum() / ( dfu.shape[1]) > 1:
          ...
          wbplots.append((indict[i],plot))
          if include_desc == 'Yes':
           plot_desc = ai.generate_text(f"Read this as input context: [{prompt}]. \n\nRead this dataframe which is used for a line chart called {indict[i]}: {dfu} \n\nPrint only an interpretation of the line chart and contextual summary(ies), no chit-chat. Filter out all boilerplate words and noise. DO NOT add in hallucinated noise. If no context, reply with: Try again with broader term. ", model_name='google/gemma-3-27b')
           plot_desc = re.sub(r'\\[a-zA-Z]+|[\${}*#]', '', plot_desc)
           wbdesc.append((indict[i],plot_desc))
          else:
            wbdesc.append(('',''))
        ...
        wbdesc.append(('',''))
        wbplots.append(('ERR_TOO LITTLE DATA FOR PLOTS OR NO RELEVANT DATA','ERR_TOO LITTLE DATA FOR PLOTS OR NO RELEVANT DATA'))
        pass #no wb data, no point in visualising nil
  else:
    wbplots = []
    wbdesc = []
  ...
  print(end-start, ' seconds taken')
  return render_template_string(HTML_TEMPLATE4, reply1=reply1, reply2=reply2, reply3=reply3, feeds = feeds, wbplots = wbplots, desc = wbdesc, categories=categories)
