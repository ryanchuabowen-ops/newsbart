...
.tabcontent {
  ...
  <div class="nav-container">
    ...
    <!--<div><details class="source-table">
      <summary><p style = 'font-size: 14px;  text-align: center;'><b style="color:Tomato;">🖍️ View highlighted Article:</b></p></summary>
...
<style>
  ...
  <div class="nav-container">
    ...
    <form action="/search" method="post" name="form">
      ...
      <div><details class="source-table" style="width: 400px;">
      <summary>🔍 Customize Seearch Options</summary>
